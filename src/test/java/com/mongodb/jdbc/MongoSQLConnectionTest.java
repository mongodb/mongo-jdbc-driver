...
class MongoSQLConnectionTest extends MongoSQLMock {
    @BeforeAll
    protected void initMocks() {
        MockitoAnnotations.initMocks(this);
    }

    // Since MongoSQLConnection cannot be created with its constructor, we have to use InjectionMocks Annotation and
