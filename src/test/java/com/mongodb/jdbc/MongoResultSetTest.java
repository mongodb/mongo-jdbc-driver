...
class MongoResultSetTest {
    ...
    static {
        ...
        rows.add(row);
        strictMongoResultSet = new MongoResultSet(null, new MongoExplicitCursor(rows), false);
        relaxedMongoResultSet = new MongoResultSet(null, new MongoExplicitCursor(rows), true);
        closedMongoResultSet = new MongoResultSet(null, new MongoExplicitCursor(rows), true);
    }
