...
public abstract class MongoDatabaseMetaData implements DatabaseMetaData {
    ...
    protected static final String BSON_BINDATA_TYPE_NAME = "binData";
    ...
    protected static final String BSON_DATE_TYPE_NAME = "date";
    protected static final String BSON_DECIMAL_TYPE_NAME = "decimal";
    protected static final String BSON_DOUBLE_TYPE_NAME = "double";
    protected static final String BSON_LONG_TYPE_NAME = "long";
    protected static final String BSON_ARRAY_TYPE_NAME = "array";
    protected static final String BSON_OBJECT_TYPE_NAME = "object";
    protected static final String BSON_OBJECTID_TYPE_NAME = "objectId";
    protected static final String BSON_DBPOINTER_TYPE_NAME = "dbPointer";
    protected static final String BSON_JAVASCRIPT_TYPE_NAME = "javascript";
    protected static final String BSON_JAVASCRIPTWITHSCOPE_TYPE_NAME = "javascriptWithScope";
    protected static final String BSON_MAXKEY_TYPE_NAME = "maxKey";
    protected static final String BSON_MINKEY_TYPE_NAME = "minKey";
    protected static final String BSON_REGEX_TYPE_NAME = "regex";
    protected static final String BSON_SYMBOL_TYPE_NAME = "symbol";
    protected static final String BSON_TIMESTAMP_TYPE_NAME = "timestamp";
    protected static final String BSON_UNDEFINED_TYPE_NAME = "undefined";
    protected static final String BSON_BSON_TYPE_NAME = "bson";
    ...
    protected Integer getPrecision(String typeName) throws SQLException {
        switch (typeName) {
    ...
    protected Boolean getCaseSensitivity(String typeName) throws SQLException {
        switch (typeName) {
            case BSON_STRING_TYPE_NAME:
            case BSON_REGEX_TYPE_NAME:
            case BSON_SYMBOL_TYPE_NAME:
    ...
    protected Boolean getFixedPrecScale(String typeName) throws SQLException {
        switch (typeName) {
            case BSON_INT_TYPE_NAME:
            case BSON_LONG_TYPE_NAME:
                return true;
    ...
    protected Integer getMinScale(String typeName) throws SQLException {
        switch (typeName) {
            case BSON_DECIMAL_TYPE_NAME:
                return 34;
            case BSON_DOUBLE_TYPE_NAME:
    ...
    protected Integer getMaxScale(String typeName) throws SQLException {
        switch (typeName) {
            case BSON_DECIMAL_TYPE_NAME:
                return 34;
            case BSON_DOUBLE_TYPE_NAME:
    ...
    protected Integer getNumPrecRadix(String typeName) throws SQLException {
        switch (typeName) {
            case BSON_DECIMAL_TYPE_NAME:
                return 10;
            case BSON_INT_TYPE_NAME:
