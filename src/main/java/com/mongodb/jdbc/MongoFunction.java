...
public class MongoFunction {
    ...
    public static final MongoFunction[] mongoSQLFunctions =
            new MongoFunction[] {
                ...
                new MongoFunction(
                        "CHAR_LENGTH", "long", "returns length of string", new String[] {"string"}),
                new MongoFunction(
                        "COALESCE",
                        null,
                        "returns the first non-null value in the list, or null if there are no non-null values.",
                ...
                new MongoFunction(
                        "SIZE", "numeric", "returns the size of an array.", new String[] {"array"}),
                new MongoFunction(
                        "SUBSTRING",
                        "string",
                        "takes a substring from a string",
    ...
    static {
        // MySQL
        Pair<String[], HashMap<String, String>> mySQLFunctionMetadata =
                buildFunctionMetadata(MongoFunction.mySQLFunctions);
        ...
        // MongoSQL
        Pair<String[], HashMap<String, String>> mongoSQLFunctionMetadata =
                buildFunctionMetadata(MongoFunction.mongoSQLFunctions);
    ...
    private static Pair<String[], HashMap<String, String>> buildFunctionMetadata(
            MongoFunction[] functions) {
