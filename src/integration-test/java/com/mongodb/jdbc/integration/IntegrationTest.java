...
public class IntegrationTest {
    ...
    //    }
    //
    //    static final String schemaPattern = "%FORMATION_S%";
    ...
    //        rs = dbmd.getTables(null, schemaPattern, tableNamePattern, null);
    //        assertEquals(7, countRows(rs));
    //    }
    //
    //    @Test
    //    public void databaseMetaDataGetSchemasTest() throws SQLException {
    //        java.util.Properties p = new java.util.Properties();
    //        p.setProperty("user", System.getenv("ADL_TEST_USER"));
    //        p.setProperty("password", System.getenv("ADL_TEST_PWD"));
    //        p.setProperty("database", "looker");
    ...
    //        Connection conn = DriverManager.getConnection(URL, p);
    //        DatabaseMetaData dbmd = conn.getMetaData();
    //        ResultSet rs = dbmd.getColumns(null, schemaPattern, null, null);
    //        ResultSetMetaData rsmd = rs.getMetaData();
    //        String[] columns =
    //                new String[] {
    //                    "TABLE_CAT",
    ...
    //        rs = dbmd.getColumns(null, schemaPattern, tableNamePattern, columnNamePattern);
    //        assertEquals(1, countRows(rs));
    //        rs = dbmd.getColumns(null, schemaPattern, tableNamePattern, columnNamePattern2);
    ...
    //        Connection conn = DriverManager.getConnection(URL, p);
    //        DatabaseMetaData dbmd = conn.getMetaData();
    //        ResultSet rs = dbmd.getColumnPrivileges(null, schemaPattern, null, null);
    //        ResultSetMetaData rsmd = rs.getMetaData();
    //        String[] columns =
    //                new String[] {
    //                    "TABLE_CAT",
    ...
    //        }
    //        assertEquals(0, countRows(rs));
    //        rs = dbmd.getColumnPrivileges(null, schemaPattern, tableNamePattern, null);
    //        assertEquals(0, countRows(rs));
    //        rs = dbmd.getColumnPrivileges(null, schemaPattern, tableNamePattern, columnNamePattern);
    //        assertEquals(0, countRows(rs));
    //        rs = dbmd.getColumnPrivileges(null, schemaPattern, tableNamePattern, columnNamePattern2);
    //        assertEquals(0, countRows(rs));
    //    }
    //
    //    @Test
    ...
    //        Connection conn = DriverManager.getConnection(URL, p);
    //        DatabaseMetaData dbmd = conn.getMetaData();
    //        ResultSet rs = dbmd.getTablePrivileges(null, schemaPattern, null);
    //        ResultSetMetaData rsmd = rs.getMetaData();
    //        String[] columns =
    //                new String[] {
    //                    "TABLE_CAT",
    ...
    //        }
    //        assertEquals(0, countRows(rs));
    //        rs = dbmd.getTablePrivileges(null, schemaPattern, tableNamePattern);
    //        assertEquals(0, countRows(rs));
    //    }
    //
